/*
Assignments/Projects RDB/SQL-5 (E-Commerce Data Analysis Project)

1. Join all the tables and create a new table called combined_table. 
(market_fact, cust_dimen, orders_dimen, prod_dimen, shipping_dimen)
1. Tüm tablolara katılın ve Combine_table adında yeni bir tablo oluşturun.
*/
...
3. Combine_table'da, Order_Date ve Ship_Date tarih farkını içeren DaysTakenForShipping olarak yeni bir sütun oluşturun.
*/
...
6. İlk satın alma ile üçüncü satın alma arasında geçen süreyi her kullanıcıya geri döndürmek için bir sorgu yazın,
...
ve bu ürünlerin müşteri tarafından satın alınan toplam ürün miktarına oranları.
*/
...
1-İşin başlangıcından bu yana aylık müşteri elde tutma oranını bulun.
*/
