/* 
Assignments/Projects RDB/SQL-3 (Discount Effects)
...
İndirim oranındaki artışın ürünler için sipariş sayısını olumlu etkileyip etkilemediğine dair ürün kimliklerini ve indirim etkilerini içeren bir rapor oluşturun.
